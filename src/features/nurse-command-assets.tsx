      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[1fr_1.2fr_1fr]">
        ...
        <CommandPanel title="Utility Badges" subtitle="Ready">
          <div className="grid grid-cols-3 gap-3">
            <UtilityBadge label="Streak" value={`${streak} Days`} icon={<Goal className="h-5 w-5" />} tone="orange" />
            <UtilityBadge label="Focus Time" value={focusTime} icon={<Cloud className="h-5 w-5" />} tone="blue" />
            <UtilityBadge label="Accuracy" value={`${accuracy}%`} icon={<CheckCircle2 className="h-5 w-5" />} tone="green" />
          </div>
        </CommandPanel>
      </div>
